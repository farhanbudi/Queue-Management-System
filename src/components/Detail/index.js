...
export const DetailInfoAntrian = (props) => {
  ...
  return (
    <div>
      <Content className="tb">
        <h1 className="title-default">Info Antrian Hari Ini ({props.date})</h1>
        <Card className="default-card" size="default">
          <div>
            <Row className="row">
              ...
              <Col span={1}>:</Col>
              <Col span={10}>
                <b>{props.data.nama_bank}</b>
              </Col>
            </Row>
            <Row className="row">
              <Col span={12}>Alamat</Col>
              <Col span={1}>:</Col>
              <Col span={10}>{props.data.alamat}</Col>
            </Row>
            <Row className="row">
              <Col span={12}>Nomor antrian yang sedang dilayani saat ini</Col>
              <Col span={1}>:</Col>
              <Col span={10}>
                <b>{props.data?.no_antrian_saat_ini}</b>
                <span> (pukul {props.data?.waktu_pelayanan})</span>
              </Col>
            </Row>
          </div>
          <Row
